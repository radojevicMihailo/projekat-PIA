...
@Component({
    selector: "app-klijent-admin",
    templateUrl: "./klijent-admin.component.html",
    styleUrls: ["./klijent-admin.component.css"],
})
export class KlijentAdminComponent implements OnInit {
