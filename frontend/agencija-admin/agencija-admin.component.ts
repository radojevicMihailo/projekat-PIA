...
@Component({
    selector: "app-agencija-admin",
    templateUrl: "./agencija-admin.component.html",
    styleUrls: ["./agencija-admin.component.css"],
})
export class AgencijaAdminComponent implements OnInit {
